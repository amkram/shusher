  ...
  return (
    <div className={classes.alignedDiv}>
      ...
      <p>
        ...
        is regularly updated and is comprised of publicly available sequences
        from{" "}
      ...
      <p>
        After placement, subtrees containing your samples can be visualized
        using{" "}
        <a
          target="_blank"
      ...
      <p>
        Only if your samples contain sensitive data. We strongly encourage you
        to share your SARS-CoV-2 sequences with the public. Sharing sequence
        data enables rapid progress in SARS-CoV-2 research and genomic contact
        tracing.
      </p>
      <p>
        ...
        that performs computation on UCSC servers. This web tool is intended to
        be used{" "}
      ...
      <p>
        ...
        leading to some performance decrease. This tool also does not
        parallelize computation while the original UShER does. If you have a
        large number of samples that contain sensitive information, we recommend
        using the UShER command-line tool. Instructions on how to install and
        use the tool are available{" "}
        <a
          target="_blank"
